...
void test_dictionaryNew_should_return_dictionary_with_length_4k(){
	...
	TEST_ASSERT_EQUAL(4096, dictionary->length);
}
...
void test_dictionaryAdd_given_ab_and_index_100_should_fail_to_add_and_return_0(){
	Dictionary *dictionary = dictionaryNew(100);
  int result;
	
	result = dictionaryAdd(dictionary, "ab", 100);
	
	TEST_ASSERT_EQUAL(0, result);
}

void test_dictionaryAdd_given_nab_and_index_101_should_fail_to_add_and_return_0(){
	Dictionary *dictionary = dictionaryNew(100);
  int result;
...
void test_dictionaryAdd_given_nab_and_index_neg_1_should_fail_to_add_and_return_0(){
	Dictionary *dictionary = dictionaryNew(100);
  int result;
